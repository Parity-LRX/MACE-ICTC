...
Usage:
    # Export:
    python -m mace_ictd.cli.export_mliap checkpoint.pth --elements H O
...
try:
    from mace_ictd.models import E3_TransformerLayer_multi
except Exception:
    E3_TransformerLayer_multi = None
try:
    from mace_ictd.models.e3nn_layers_channelwise import (
        E3_TransformerLayer_multi as E3_TransformerLayer_multi_channelwise,
    )
except Exception:
    E3_TransformerLayer_multi_channelwise = None
try:
    from mace_ictd.models.pure_cartesian_sparse_layers import (
        PureCartesianSparseTransformerLayer,
    )
except Exception:
    PureCartesianSparseTransformerLayer = None
try:
    from mace_ictd.models.pure_cartesian_sparse_layers_save import (
        PureCartesianSparseTransformerLayerSave,
    )
except Exception:
    PureCartesianSparseTransformerLayerSave = None
try:
    from mace_ictd.models.pure_cartesian_ictd_layers_full import PureCartesianICTDTransformerLayer
except Exception:
    PureCartesianICTDTransformerLayer = None
try:
    from mace_ictd.models.pure_cartesian_ictd_layers_full_o3 import PureCartesianICTDO3TransformerLayer
except Exception:
    PureCartesianICTDO3TransformerLayer = None
try:
    from mace_ictd.models.pure_cartesian_ictd_layers_o3 import PureCartesianICTDSaveO3TransformerLayer
except Exception:
...
class LAMMPS_MLIAP_MFF(MLIAPUnified):
    ...
    def from_checkpoint(
        ...
        if mode == "pure-cartesian-ictd-fix":
            ...
            from mace_ictd.models.cue_layers_channelwise import (
