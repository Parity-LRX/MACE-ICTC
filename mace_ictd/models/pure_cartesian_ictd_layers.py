...
from mace_ictd.models.radial_basis import soft_one_hot_linspace_mace_cutoff as soft_one_hot_linspace
import math
...
from mace_ictd.models.ictd_fast import _counts_list
from mace_ictd.models.mlp import RobustScalarWeightedSum
from mace_ictd.models.mlp import MainNet
from mace_ictd.models.long_range import apply_long_range_modules, configure_long_range_modules
...
def _sym_rank_linear_indices_and_coefs(L: int) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    Ordering of (a,b,c) follows `mace_ictd.models.ictd_fast._counts_list(L)`,
